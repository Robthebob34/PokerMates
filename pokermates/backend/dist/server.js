...
console.log('SocketService imported:', {
    isClass: typeof socketService_1.default === 'function',
    isConstructor: typeof socketService_1.default === 'function' && 'prototype' in socketService_1.default,
    name: socketService_1.default?.name
});
...
app.use(authMiddleware_1.attachUserFromCookie);
// Auth routes
...
try {
    ...
    const socketService = new socketService_1.default(io);
